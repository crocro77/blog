            ...
            <div class="col s12">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l4 center">
                        ...
                        <br/><br/>
                        <form method="post" role="form" onclick="return confirm('Etes vous sûr de vouloir supprimer ce chapitre ?')" action="index.php?p=admin&menu=list&action=delete&id=<?= $chapter->getId(); ?>">
